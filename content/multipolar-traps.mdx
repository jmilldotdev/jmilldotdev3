...
Need a <Link href="/c/coordination-mechanism" className="text-[var(--color-primary)] hover:underline hover:text-[var(--color-secondary)] transition-colors font-medium">Coordination Mechanism</Link> often to avoid.
