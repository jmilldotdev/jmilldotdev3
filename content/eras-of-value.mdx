...
- _The Perspective Era_ - "Perspective is about having an opinion on what matters and what doesn't"
	...
	- No job security
	- **startup of one**
	- understanding your competitive advantages is key, <Link href="/c/specific-knowledge" className="text-[var(--color-primary)] hover:underline hover:text-[var(--color-secondary)] transition-colors font-medium">Specific Knowledge</Link>
