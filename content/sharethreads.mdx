...
!<Link href="/c/pasted-image-20210810215823png" className="text-[var(--color-primary)] hover:underline hover:text-[var(--color-secondary)] transition-colors font-medium">Pasted image 20210810215823.png</Link>
